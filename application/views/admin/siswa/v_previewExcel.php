    ...
    <div class="card">
      ...
      <div class="card-body">
        ...
        <?php 
           ...
           <form method="post" action="<?php echo base_url('go_ciclx_usradmin/A_siswa/import') ?>">
                    ...
                    <?php
                      foreach($sheet as $row){
                          ...
                          if($numrow > 1){
                            ...
                            if($nama == "" or $jenis_kelamin == "" or $nis == ""){
              ...
              <?php 
                    ...
                    echo "<a href='".base_url("go_ciclx_usradmin/A_siswa")."' class='btn btn-secondary pull-right' style='margin-top: 20px;'>Cancel</a>";      
